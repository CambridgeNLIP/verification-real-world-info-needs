...
"""
Train a 3way model to predict whether a sentence can be used as evidence for or against a claim.
"""
...
from reader.claim_sentence_reader import ClaimSentenceReader
...
trainset = ClaimSentenceReader(data_train_path, labels_mode='3way')
